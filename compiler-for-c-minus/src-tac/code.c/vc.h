...
#define ERR_LEN     32			/* Size of error message */
...
#define  PARAM_MASK	0x80000000
#define  MASK(x)	(x | PARAM_MASK)
#define  UNMASK(x)	(x & ~PARAM_MASK)
...
#define  TAC_GREATER_EQUAL      13	 /* a >= b */
#define  TAC_LESS_EQUAL   	14	 /* a <= b */
#define  TAC_GREATER		15	 /* a > b */
#define  TAC_LESS		16	 /* a < b */
#define  TAC_NOT_EQUAL		17	 /* a != b */
#define  TAC_EQUAL		18	 /* a == b */
...
#define  TAC_LABEL       19              /* Marker for LABEL a */
#define  TAC_VAR         20              /* Marker for VAR a */
#define  TAC_BEGINFUNC   21              /* Markers for function */
...
extern SYMB  *lookup( SYMB **tab, char *text ) ;
