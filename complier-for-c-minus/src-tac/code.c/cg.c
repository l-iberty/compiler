...
xmlDocPtr       tac_doc = NULL;
xmlNodePtr      tac_root = NULL;
...

{
        ...
        tac_doc = xmlNewDoc(BAD_CAST ("1.0"));
        tac_root = xmlNewNode(NULL, BAD_CAST ("tac_list"));
        xmlDocSetRootElement(tac_doc, tac_root);
